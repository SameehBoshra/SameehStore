    ...
    <div class="main-menu-content hidden-content ">
       ...
       {{--      <li class="nav-item  open ">
            ...
            <li class="nav-item"><a href="">
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('dashboard.Category.index')}}" data-i18n="nav.dash.ecommerce"> {{trans('msg.showall')}}  </a>
                    </li>
                    <li><a class="menu-item" href="{{route('dashboard.Category.create')}}" data-i18n="nav.dash.crypto">
           ...
           {{--  <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('dashboard.Sub.Category.index')}}"
                                          data-i18n="nav.dash.ecommerce"> {{trans('msg.showall')}}  </a>
                    </li>
                    <li><a class="menu-item" href="{{route('dashboard.Sub.Category.create')}}" data-i18n="nav.dash.crypto">
...
{{-- settings --}}
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{trans('msg.Shipping')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('editShippingMethod','free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{trans('msg.shippingfree')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('editShippingMethod','local')}}">{{trans('msg.shippingin')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('editShippingMethod','outer')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{trans('msg.shippingout')}}</a>
                            </li>
