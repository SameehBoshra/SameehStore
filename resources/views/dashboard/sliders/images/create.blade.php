                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{trans('msg.silderpage')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>  {{trans('msg.silderimage')}} </h4>
                                                <div class="form-group">
                                                    <div id="dpz-multiple-files" class="dropzone dropzone-area">
                                                        <div class="dz-message">{{trans('msg.yuocanloadmoreonephoto')}}</div>
                                                    </div>
                                                    <br><br>
                                                </div>
