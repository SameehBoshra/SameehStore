                                ...
                                <div class="card-body">
                                    <form class="form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($brand->photo)
                                            <input type="file" src="{{$brand->photo}}"id="file" name="photo">
                                            @endif
                                            @error('photo')
