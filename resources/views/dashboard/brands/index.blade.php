    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title" >{{trans('msg.brandpage')}}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.brands.index') }}">{{trans('msg.brandpart')}}</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{trans('msg.allbrandpart')}}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <table class="table display nowrap table-striped table-bordered scroll-horizontal">
                                        <thead>
                                            <tr>
                                                <th>{{trans('msg.brandname')}}</th>
                                                <th>{{trans('msg.status')}}</th>
                                                <th> {{trans('msg.brandphoto')}}</th>
...
{{--                                                         <td></td>
 --}}                                                        <td>
                                                            <img  name="photo" style="width: 150px; height: 100px;" src="{{ asset('storage/' . $brand->photo)}}" alt="">
                                                        </td>
                                                        <td>
